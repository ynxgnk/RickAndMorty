...
protocol RMEpisodeDetailViewDelegate: AnyObject { /* 1215 */
    func rmEpisodeDetailView(_ detailView: RMEpisodeDetailView, didSelect character: RMCharacter)  /* 1217 */
}

final class RMEpisodeDetailView: UIView { /* 931 and final */

    public weak var delegate: RMEpisodeDetailViewDelegate? /* 1216 */
    
    private var viewModel: RMEpisodeDetailViewViewModel? { /* 1048 */ /* 1097 add didSet */
        didSet { /* 1098 */
            spinner.stopAnimating() /* 1099 */
            self.collectionView?.reloadData() /* 1125 means: to retriger functions in extension RMEpisodeDetailView(numOfSections...)*/
...
//        backgroundColor = .red /* 977 */
    ...
    public func configure(with viewModel: RMEpisodeDetailViewViewModel) { /* 1047 */
        self.viewModel = viewModel /* 1049 */
    }
}

extension RMEpisodeDetailView: UICollectionViewDelegate, UICollectionViewDataSource { /* 1087 */
...
extension RMEpisodeDetailView { /* 1066 */
    ...
    func createCharacterLayout() -> NSCollectionLayoutSection { /* 1168 copy from createInfoSectionLayout(588) and paste */
        let item = NSCollectionLayoutItem(
            layoutSize: NSCollectionLayoutSize( /* 1172 copy from */
                widthDimension: .fractionalWidth(UIDevice.isiPhone ? 0.5 : 0.25), /* 2178 add UIDeivice.isiPhone */
        ...
        let group = NSCollectionLayoutGroup.horizontal( /* 1174 */
            layoutSize: NSCollectionLayoutSize(
                ...
                heightDimension: .absolute(UIDevice.isiPhone ? 260 : 320) /* 2179 add UIDevice.isiPhone */
            ),
//            subitems: [item, item] /* 1175 */
            subitems: UIDevice.isiPhone ? [item, item] : [item, item, item , item] /* 2177 */
        )
